                    ...
                    <div class="inventory-details-body">
                        ...
                        @if($canEdit && $products->isNotEmpty())
                            ...
                            @if($activeLocations->isNotEmpty())
                                <section id="product-variant-editor" class="inventory-variant-editor" data-action="{{ route('inventario-bodega.stock-talla.store') }}" data-csrf="{{ csrf_token() }}" data-stocks="{{ $variantStocksByLocation->toJson() }}" data-product-page="{{ $products->currentPage() }}" data-product-search="{{ $productSearch }}" data-highlight-variant="{{ $adjustingVariantId ?: '' }}" hidden>
