...
<div class="inventory-page">
    ...
    @elseif($vista === 'kizeo')
        ...
        <nav class="inventory-kizeo-origin" aria-label="Origen de las entregas Kizeo">
            <a href="{{ route('inventario-bodega.index', ['vista' => 'kizeo', 'ubicacion_id' => $selectedLocation, 'kizeo_origen' => 'vigentes']) }}" class="inventory-kizeo-origin-link {{ ($kizeoQueue ?? 'vigentes') === 'vigentes' ? 'active' : '' }}">Vigentes</a>
            <a href="{{ route('inventario-bodega.index', ['vista' => 'kizeo', 'ubicacion_id' => $selectedLocation, 'kizeo_origen' => 'historico']) }}" class="inventory-kizeo-origin-link {{ ($kizeoQueue ?? 'vigentes') === 'historico' ? 'active' : '' }}">Histórico · no descuenta ({{ number_format($kizeoStats['historical']) }})</a>
        </nav>
