                    ...
                    <div class="inventory-details-body">
                        ...
                        @if($canEdit && $products->isNotEmpty())
                            ...
                            <form method="POST" id="product-editor" data-action-base="{{ url('inventario-bodega/productos') }}" class="inventory-editor inventory-product-general">@csrf @method('PUT')
                                <div><h3>Gestionar producto y tallas</h3><p>Selecciona el producto una sola vez. Si ya no se usa, desmarca Producto vigente: el historial se conserva y puedes reactivarlo después. Sincroniza con Kizeo para actualizar las entregas nuevas.</p></div>
