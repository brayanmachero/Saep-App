...
<div class="page-container warehouse-dashboard">
    ...
    <section class="glass-card warehouse-filter" aria-label="Filtros del dashboard">
        <form method="GET" action="{{ route('entregas-bodega-dashboard.index') }}" class="warehouse-filter-grid">
            ...
            <div style="display:flex;gap:.45rem"><button type="submit" class="btn-premium" style="font-size:.8rem;flex:1" title="Aplicar filtros"><i class="bi bi-funnel-fill"></i> Aplicar</button><a href="{{ route('entregas-bodega-dashboard.index', ['todo' => 1]) }}" class="btn-secondary" style="display:inline-flex;align-items:center;text-decoration:none" title="Quitar filtros y ver el historial"><i class="bi bi-x-lg"></i></a></div>
        </form>
    </section>
