    ...
    document.getElementById('btn-preview').addEventListener('click', () => {
        ...
        fields.forEach(f => {
            if (f.type === 'divider') {
                ...
                else if (f.type === 'radio') html += (f.options||[]).map(o=>`<label style="display:flex;align-items:center;gap:0.5rem;margin-top:0.35rem;"><input type="checkbox" disabled> ${o}</label>`).join('');
