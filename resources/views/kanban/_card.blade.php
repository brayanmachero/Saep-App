...
@endphp
<div class="kanban-card" data-tarea-id="{{ $tarea->id }}" style="background:var(--card-bg);border:1px solid var(--border-color);border-left:3px solid {{ $pColor }};border-radius:8px;padding:.6rem .75rem;margin-bottom:.5rem;cursor:grab;transition:box-shadow .15s;">
