...
<table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;overflow:hidden;border:1px solid #e2e8f0;">
    @include('emails.partials.saep_header', [
        ...
        'badge' => 'Acta de devolucion',
        'badgeColor' => '#e11d48',
        'accentColor' => '#e11d48',
    ])
    <tr>
        <td style="padding:35px 30px;">
            <h1 style="margin:0 0 8px;font-size:22px;font-weight:700;color:#881337;">Acta de Devolución de Vehículo</h1>
            <p style="margin:0 0 24px;font-size:14px;color:#64748b;">Recepción oficial en base o instalaciones</p>
