...
<head>
    ...
    <title>Postulacion recibida - SAEP</title>
</head>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#eef1f5;margin:0;padding:24px 12px;">
    <tr>
        <td align="center">
            <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="width:640px;max-width:100%;background:#ffffff;border:1px solid #d8dee9;border-radius:8px;overflow:hidden;">
                <tr>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    ...
                                    <div style="font-size:12px;color:#cbd5e1;margin-top:6px;">Portal de Contratacion</div>
                                </td>
                                <td align="right" style="vertical-align:top;">
                                    <span style="display:inline-block;border:1px solid rgba(255,255,255,.35);color:#ffffff;font-size:11px;font-weight:700;letter-spacing:.08em;padding:6px 10px;border-radius:4px;">RECIBIDA</span>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:28px;">
                        <h1 style="font-size:22px;line-height:1.25;color:#0f172a;margin:0 0 10px;">Postulacion recibida correctamente</h1>
                        <p style="font-size:14px;line-height:1.6;color:#475569;margin:0 0 18px;">
                            Hola <strong style="color:#111827;">{{ $postulante->nombre }}</strong>, recibimos tu postulacion.
                            Nuestro equipo de RRHH revisara la informacion y te contactara si requiere antecedentes adicionales.
                        </p>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#eef6ff;border:1px solid #cfe6ff;border-radius:8px;margin:0 0 20px;">
                            <tr>
                                <td style="padding:18px 20px;text-align:center;">
                                    <div style="font-size:11px;line-height:1;text-transform:uppercase;letter-spacing:.08em;color:#64748b;margin-bottom:8px;">Folio de postulacion</div>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:8px;overflow:hidden;margin-bottom:20px;">
                            <tr>
                                <td colspan="2" style="background:#f8fafc;padding:10px 14px;font-size:12px;font-weight:800;color:#334155;text-transform:uppercase;letter-spacing:.05em;">Resumen</td>
                            </tr>
                            <tr>
                                <td style="width:36%;padding:12px 14px;border-top:1px solid #e2e8f0;font-size:12px;color:#64748b;">RUT</td>
                                <td style="padding:12px 14px;border-top:1px solid #e2e8f0;font-size:13px;color:#111827;font-weight:600;">{{ $postulante->rut }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding:12px 14px;border-top:1px solid #e2e8f0;font-size:12px;color:#64748b;">Fecha</td>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:8px;overflow:hidden;margin-bottom:20px;">
                            <tr>
                                <td colspan="2" style="background:#f8fafc;padding:10px 14px;font-size:12px;font-weight:800;color:#334155;text-transform:uppercase;letter-spacing:.05em;">Documentos informados</td>
                            </tr>
                            @php
                                $docsLabels = [
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border-left:4px solid #0f1b4c;border-radius:6px;">
                            <tr>
                                <td style="padding:14px 16px;">
                                    <p style="font-size:13px;line-height:1.55;color:#475569;margin:0;">
                                        Este correo es solo informativo. No contiene botones de accion ni requiere respuesta inmediata.
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:16px 28px;text-align:center;">
                        <p style="font-size:11px;line-height:1.5;color:#94a3b8;margin:0;">
                            &copy; {{ date('Y') }} SAEP - Notificacion automatica del Portal de Contratacion
                        </p>
                    </td>
                </tr>
            </table>
