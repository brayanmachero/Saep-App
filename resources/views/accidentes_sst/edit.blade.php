        ...
        <form method="POST" action="{{ route('accidentes-sst.update', $accidenteSst) }}">
            ...
            <div class="form-group">
                ...
                <div class="tag-select-wrap" data-name="lesiones_ids[]" data-tipo="lesion"
                     ...
                     data-preload='@json($accidenteSst->lesionesOpciones->map(fn($o)=>["id"=>$o->id,"nombre"=>$o->nombre]))'>
            ...
            <div class="form-group">
                ...
                <div class="tag-select-wrap" data-name="causas_ids[]" data-tipo="causa"
                     ...
                     data-store="{{ route('accidentes-sst.opciones.store') }}"
                     data-preload='@json($accidenteSst->causasOpciones->map(fn($o)=>["id"=>$o->id,"nombre"=>$o->nombre]))'>
                    <div class="tag-selected"></div>
                    <div style="position:relative">
            ...
            <div class="form-group">
                ...
                <div class="tag-select-wrap" data-name="medidas_ids[]" data-tipo="medida"
                     ...
                     data-store="{{ route('accidentes-sst.opciones.store') }}"
                     data-preload='@json($accidenteSst->medidasOpciones->map(fn($o)=>["id"=>$o->id,"nombre"=>$o->nombre]))'>
                    <div class="tag-selected"></div>
                    <div style="position:relative">
...
document.querySelectorAll('.tag-select-wrap').forEach(wrap => {
    ...
    // Preload existing selections (edit mode)
    try {
        const preload = JSON.parse(wrap.dataset.preload || '[]');
        preload.forEach(item => selected.set(String(item.id), item.nombre));
    } catch(e) {}
