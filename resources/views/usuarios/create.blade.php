            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-input @error('name') is-invalid @enderror"
                        value="{{ old('name') }}" placeholder="Ej: Juan">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nacionalidad" class="form-input @error('nacionalidad') is-invalid @enderror"
                        value="{{ old('nacionalidad') }}" placeholder="Ej: Chilena">
            ...
            <div class="form-grid-2">
                ...
                <div class="form-group">
                    ...
                    <select name="tipo_nomina" class="form-input">
                        <option value="NORMAL" {{ old('tipo_nomina') == 'NORMAL' ? 'selected' : '' }}>Normal</option>
                        <option value="TRANSITORIO" {{ old('tipo_nomina') == 'TRANSITORIO' ? 'selected' : '' }}>Transitorio</option>
                    </select>
                </div>
