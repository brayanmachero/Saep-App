...
class VehiculoDevolucionMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: "Acta de DEVOLUCIÓN Vehículo - {$this->data['gestion']} - PPU: {$this->data['patente']}",
        );
    }
    ...
    {
        return new Content(
            view: 'emails.vehiculo_devolucion',
