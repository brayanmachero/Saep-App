...
class ComercialSeeder extends Seeder
{
    ...
    private function parametros(): array
    {
        return [
            ...
            ['clave' => 'HORA_NORMAL_FACTOR_SUB', 'nombre' => 'Factor Hora HHEE SUB', 'descripcion' => 'Factor de hora normal HHEE usado por la plantilla SUB.', 'valor' => '0.005303', 'tipo' => 'decimal', 'editable' => true, 'categoria' => 'HORAS', 'version' => 1],
