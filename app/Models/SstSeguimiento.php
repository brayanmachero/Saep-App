...
class SstSeguimiento extends Model
{
    ...
    protected $fillable = ['actividad_id','mes','programado','realizado','observacion','actualizado_por','fecha_actualizacion'];

    protected $casts = ['programado'=>'boolean','realizado'=>'boolean','mes'=>'integer'];
